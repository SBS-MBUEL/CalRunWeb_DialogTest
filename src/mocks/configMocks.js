...
const _device = [
	{
		...
		controls: [
			...
			{label:'Delay before sampling', type:'numerictext', list:[], width:'200px', height:'30px', control:null, value:'0', maxLength:20, titleOrder:-1, settingIndex: 99},
...
const _datapoint = [
	...
	},
	{
		...
		[
			...
			{label:'Peristaltic Pump Number', type:'numerictext', list:[], width:'100px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Injection Volume', type:'numerictext', list:[], width:'100px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Pump Rate', type:'numerictext', list:[], width:'100px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
...
const _system = [
	{
		...
		[
			...
			{label:'Number of sequential calibrations', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Samples to average', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Additional Wait Time Once Stable (ms)', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Sample Interval', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Data Point Timeout', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Number of devices to calibrate', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Reference Sensor Timeout', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Device Under Test Timeout', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			...
			{label:'Drain time (sec)', type:'numerictext', list:[], width:'100px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},		
			{label:'Fill time (sec)', type:'numerictext', list:[], width:'100px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Notes', type:'textarea', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Sine Max target slope', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
			{label:'Sentinel target offset', type:'numerictext', list:[], width:'50px', height:'30px', control:null, value:'Not Set', maxLength:20, titleOrder:-1},
		]
	},
	{
		for:'calibrationParameter',
